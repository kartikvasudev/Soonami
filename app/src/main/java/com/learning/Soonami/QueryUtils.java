...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquakes> extractEarthquakes() throws JSONException {
        ...
        for(int i=0;i<features.length();i++)
        {
            ...
            long date = properties.getLong("mag");
        ...
        // build up a list of Earthquakes objects with the corresponding data.
